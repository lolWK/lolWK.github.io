...
> 찬찬히 보고 싶어서 주 2회 아티클 읽기로 바꾸기로 했다.ㄴ
> (추가) 어렵거나 잘 모르는 것도 그냥 보기로 했다. 새로운 것을 아는 것도 좋지 않을까?
...
#### 23/4/8 [ESLint와 AST로 코드 퀄리티 높이기](https://toss.tech/article/improving-code-quality-via-eslint-and-ast)

AST를 저런 식으로도 사용할 수 있구나 ..!
